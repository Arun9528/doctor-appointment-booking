          ...
          <section className="space-y-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-5 shadow-lg space-y-2">
              ...
              <p className="text-[#5e5e5e] text-sm">
                ...
                fugiat dolorem quisquam blanditiis doloribus, ullam, earum iure
                obcaecati ipsum expedita. Quasi mollitia enim autem totam
                excepturi tempora ducimus similique voluptatem, eum dolor aut.
                Voluptatem aliquam quidem aspernatur corrupti. Lorem ipsum
                dolor, sit amet consectetur adipisicing elit. Quam sapiente
                quidem repellendus inventore accusamus! Asperiores officia,
                illum exercitationem animi consequatur consequuntur velit. Et
                sint voluptate maiores commodi suscipit quas adipisci error
                modi, at, sit qui consequuntur delectus aperiam cum praesentium
                tempore. Praesentium nisi dolorem consectetur consequuntur unde,
                odit ullam magnam.
              </p>
            </div>
          </section>
